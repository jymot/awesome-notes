...
## Library
 - [`Tencent` mmkv `An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS and Android.`](https://github.com/tencent/mmkv)
...
## Net
 - [mars `Tencent` `Mars is a cross-platform network component developed by WeChat.`](https://github.com/Tencent/mars)
